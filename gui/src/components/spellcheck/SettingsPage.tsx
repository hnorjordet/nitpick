    ...
    <div className="tab-content" style={{ overflowY: "auto" }}>
      <div className="settings-page">
        ...
        <section className="settings-section" aria-labelledby="sec-dics">
          <h2 id="sec-dics" className="settings-section" style={{ fontSize: 14, fontWeight: 600, marginBottom: 12, paddingBottom: 6, borderBottom: "1px solid var(--border)" }}>
            Dictionaries
          </h2>
          ...
          {loadingDics && (
            <div style={{ padding: 8 }} role="status" aria-live="polite">
        ...
        <section className="settings-section" aria-labelledby="sec-termlists">
          ...
          >
            {settings.termlists.length === 0 && (
              <li style={{ fontSize: 12, color: "var(--text-secondary)", listStyle: "none" }}>
                No termlists added.
              </li>
            )}
        ...
        <section className="settings-section" aria-labelledby="sec-lang">
          ...
          <p className="warning-text" style={{ marginTop: 6 }} role="note">
        ...
        <section className="settings-section" aria-labelledby="sec-qa-checks">
          ...
          <fieldset style={{ border: "none", padding: 0, margin: "0 0 12px 0" }}>
            <legend style={{ fontSize: 12, fontWeight: 600, color: "var(--text-secondary)", marginBottom: 4 }}>
        ...
        <section className="settings-section" aria-labelledby="sec-display-mode">
          ...
          >
            {([
              ...
              <label key={opt.value} className="checkbox-row" style={{ alignItems: "flex-start" }}>
                <input
                  type="radio"
